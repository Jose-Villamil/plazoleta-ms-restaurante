    ...
    SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(reg -> reg
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/v1/restaurantEmployee").hasRole(ROLE_EMPLOYEE)
                        .requestMatchers(HttpMethod.PATCH, "/api/v1/restaurantEmployee/**").hasRole(ROLE_EMPLOYEE)
                        .requestMatchers(HttpMethod.GET, "/api/v1/restaurants/**").authenticated()
                        .requestMatchers(HttpMethod.GET, "/api/v1/owners/restaurants/**").hasRole(ROLE_OWNER)
